...
const DeleteAccountModal = ({
  ...
  return (
    <>{modal && <div className="select-none relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg ">
            <div className="bg-white dark:bg-black px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white" id="modal-title">Delete Account</h3>
                  <div className="mt-2 !transition-none">
                    Do you really want to delete your Account?
                    <input value={password} type="text" onChange={handleChange} className='outline-none border bg-transparent py-1 border-gray-500 dark:border-gray-200 rounded w-72' placeholder='Enter Password' />
            ...
            <div className="bg-gray-50 dark:bg-black px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button type="submit" className="mt-3 inline-flex w-full justify-center rounded-md bg-transparent p-1 mx-1 text-red-500 shadow-sm border-red-500 border active:bg-red-400 active:text-red-500 sm:mt-0 sm:w-auto" onClick={onSubmit} disabled={loading}>Delete Account</button>
